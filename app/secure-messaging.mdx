---
title: Enigm App Secure Messaging
...
Capture resistance should be documented as a privacy and exposure-reduction layer that complements end-to-end encryption, Device Trust, protected key material, secure viewers, and message expiration.
