...
<CardGroup cols={2}>
  ...
  <Card title="Enigm Command" icon="panel-top" href="/platform/control-panel">
...
<CardGroup cols={3}>
  <Card title="Privacy by design" icon="shield-check" href="/security/privacy-principles">
    Foundational privacy principles for data minimization, identity minimization, metadata reduction, and user control.
  </Card>
  <Card title="Security model" icon="lock-keyhole" href="/security/security-model">
    Defense-in-depth model across Enigm, Enigm OS, Enigm Command, Enigm Server, Enigm Key, and Enigm eSIM.
  </Card>
  <Card title="Product architecture" icon="network" href="/platform/architecture">
