---
title: Welcome to the Enigm documentation
...
<div className="enigm-card-grid">
  <CardGroup cols={2}>
    ...
    <Card title="Enigm eSIM" href="/platform/esim">
      Global data-only mobile connectivity with identity-minimizing activation and account-linked lifecycle management.
    </Card>
  </CardGroup>
</div>
