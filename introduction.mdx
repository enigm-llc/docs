...
<div className="enigm-intro-panel">
  <div className="enigm-intro-panel__main">
    <p className="enigm-intro-eyebrow">Private communications, secure devices, controlled access</p>
    <h2>Product documentation for a privacy-first security ecosystem.</h2>
    <p>
      Enigm documentation connects user-facing workflows with the trust boundaries behind them: encrypted communication, device validation, private environments, secure connectivity, emergency workflows, and governance controls.
    </p>
  </div>
  <div className="enigm-intro-panel__side">
    <div>
    ...
    <div>
      <span>Audience</span>
      <strong>Users, auditors, engineers</strong>
    </div>
  </div>
</div>
...
Use these entry points depending on what you need to understand first:

<div className="enigm-card-grid enigm-card-grid--compact">
  <CardGroup cols={3}>
    <Card title="Product architecture" href="/platform/architecture">
      Learn how Enigm products, trust boundaries, privacy controls, and governance layers fit together.
    </Card>
    <Card title="Enigm Link quickstart" href="/quickstarts/enigm-link">
      Start the official USB secure environment and confirm protected state before using the secure browser.
    </Card>
    <Card title="Security model" href="/security/security-model">
      Review the public defense-in-depth model across products, devices, updates, and administration.
    </Card>
  </CardGroup>
</div>
