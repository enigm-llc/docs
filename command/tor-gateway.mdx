...
The Tor Gateway is not intended to replace Enigm App, Enigm Proxy, VPN Service, Enigm eSIM connectivity, Enigm Command authorization, Enigm Server, secure messaging, secure calls, or Enigm OS.
...
- **Enigm Proxy**: separate app-scoped traffic-separation layer for Enigm App product traffic.
