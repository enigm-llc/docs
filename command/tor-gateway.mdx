...
- Administrative workflows are excluded from the Tor Gateway access model.
- Platform management workflows are excluded.
- Internal operational workflows are excluded.
- Sensitive account, device, messaging, and call workflows remain outside Tor Gateway.
...
- **Enigm Command**: may govern Tor Gateway lifecycle or policy configuration, but the Tor Gateway is not an administrative access surface for Enigm Command.
