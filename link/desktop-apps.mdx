...
The current production desktop/USB app version is `1.0.10`.
...
- The app can request access to the USB or disk, especially on first use, so it can validate the official device, verify USB integrity, update files, and maintain official metadata.
