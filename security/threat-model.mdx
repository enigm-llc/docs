...
The Enigm threat model covers Enigm App, Enigm Command, Enigm Server, Enigm OS, Trust Security Center, OTA Architecture, Remote Attestation, Threat Intelligence Platform, Enyra, Enigm Proxy, VPN Service, Tor Gateway, Hardware-Backed Signing, and Controlled Device Management.
...
An actor attempts to misuse Enigm Proxy, VPN Service, Enigm eSIM connectivity policy, or Tor Gateway policy, routing eligibility, access eligibility, or blocking outcomes.
