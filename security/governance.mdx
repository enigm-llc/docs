...
<Card title="ISO/IEC 27001:2022 Certificate" href="https://raw.githubusercontent.com/enigm-llc/docs/main/assets/compliance/enigm-iso-27001-certificate.pdf">
...
Public Enigm documentation describes implemented production products and production capabilities unless a section explicitly identifies a scoped deployment model.
...
| Enigm Proxy and VPN Service | Implemented and in production | Private infrastructure assessment evidence available under NDA. |
...
| Production Release-Signing Authority | Implemented and in production | Separated from the OTA Manifest Signing Authority and governed through Hardware-Backed Signing controls. |
