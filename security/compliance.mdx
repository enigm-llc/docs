...
This documentation should not imply that every Enigm product, infrastructure component, operational process, or future feature is automatically inside the certified scope unless it is explicitly included.
