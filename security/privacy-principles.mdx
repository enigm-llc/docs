...
Enigm documentation should describe data collection and retention in terms of necessity, scope, and purpose.
...
Metadata reduction is intended to lower exposure and reduce confidence in simple communication-pattern inference. It should not be interpreted as an absolute identity or traffic-analysis guarantee.
