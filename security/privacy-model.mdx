...
Enigm-controlled servers and services are operated under Enigm's Swiss subsidiary and Swiss legal governance. For processing activities involving users in the European Union, Enigm is designed to align with GDPR/RGPD principles.
...
Enigm's privacy model is implemented within the legal governance framework of Enigm's Swiss subsidiary for Enigm servers and services. This governance statement applies to Enigm-operated services and does not imply that Enigm operates third-party carrier infrastructure used for Enigm eSIM carrier-layer connectivity.
