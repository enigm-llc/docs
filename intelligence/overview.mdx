...
- Preserve audit-relevant evidence without exposing protected content.
- Improve operational security posture through consistent security analytics.

## Threat Detection

Threat detection uses detection signals and security telemetry to identify potentially suspicious activity, policy violations, misuse patterns, or security-relevant anomalies.
...
Enyra is an intelligence capability within the Enigm ecosystem. It integrates with Enigm Intelligence to support evaluated security outcomes, risk assessment, detection enrichment, and defensive response workflows.
