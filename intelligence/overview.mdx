...
Enyra is a user-facing intelligence capability within the Enigm ecosystem. It integrates with Enigm Intelligence to support evaluated security outcomes, risk assessment, detection enrichment, and defensive response workflows for authorized users.
