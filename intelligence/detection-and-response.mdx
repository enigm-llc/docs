...
Enigm Intelligence transforms security observations into defensive context for higher-level security workflows. It is designed to support threat visibility, risk prioritization, investigation, and risk-reduction decisions without turning user communications into security inputs.
...
- Support proportionate defensive controls and authorized security review.
...
flowchart TD
  ...
  Visibility["Security Review / Enyra"]
...
Correlation is designed to improve understanding of related activity. It supports risk evaluation and investigation, but it should not be treated as final platform truth without context and authorized review where required.
...
Defensive actions are designed to balance security, reliability, privacy, and operational stability. Sensitive actions should remain governed by authorization, policy, and review requirements. Automation supports security workflows; it does not replace security governance.

## Relationship With Enyra

Enyra consumes security context produced by Enigm Intelligence. It supports security correlation, event summarization, risk explanation, context retrieval, and defensive activity review.

Enyra does not replace detection systems, correlation systems, risk evaluation, or enforcement mechanisms. It operates as an AI-assisted analysis layer over security context, not as the source of platform truth.
