---
title: Enigm Defensive Blocking Architecture
...
Automated controls are intended to reduce risk quickly when conditions justify action. Public documentation describes control categories only and does not publish operational details.
