...
This documentation intentionally excludes third-party connectivity relationships, commercial arrangements, activation backends, deployment topology, and implementation-sensitive behavior.
