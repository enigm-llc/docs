...
- Mantenga los controles del dispositivo separados del texto claro de los mensajes.
...
Las capacidades de los dispositivos administrados deben permanecer separadas del acceso a texto claro de mensajes. La administración de dispositivos no es un mecanismo para eludir el cifrado de un extremo a otro.
...
OTA proporciona ciclo de vida de actualización, firma, verificación, revisión de lanzamiento y comportamiento de implementación controlado para actualizaciones Enigm OS.
