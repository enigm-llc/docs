...
flowchart TD
  ...
  Compilación["Integridad de compilación"]
...
### Control 1: Integridad de la compilación

Propósitos:

- Construcción de producción.
- Estado de versión confiable.
- Procedencia de emisión autorizada.

La integridad de la compilación evalúa si el software del dispositivo corresponde a un estado de versión de producción autorizado.
...
Las controles de producción no proporciona acceso al texto en claro de los mensajes y no reemplazan el cifrado de extremo a extremo Enigm App.
...
La evidencia de producción está diseñada para respaldar el estado de confianza, la revisión del cumplimiento y la visibilidad de la seguridad. No debe incluir contenido de mensajes, contenido multimedia, contenido de llamadas, archivos adjuntos, documentos o conversaciones de usuarios.
...
La gestión administrativa de dispositivos debe permanecer separada de la confidencialidad de los mensajes. La visibilidad del cumplimiento de la producción no proporciona acceso a texto en claro de mensajes.
