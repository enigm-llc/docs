...
description: Arquitectura de actualización OTA de Enigm OS, ciclo de vida de release y modelo de verificación del cliente.
---

La arquitectura OTA de Enigm OS ofrece de forma segura actualizaciones de software de confianza a dispositivos elegibles a través de control de lanzamiento controlado, verificación de actualizaciones e implementación por etapas.
...
La entrega OTA no reemplaza la firma de lanzamiento, la verificación de artefactos, la validación del lado del cliente, Device Trust ni las controles de producción.

## Propósito de la OTA

OTA existe para entregar de forma segura actualizaciones de software de confianza a dispositivos elegibles.

La arquitectura está diseñada para garantizar que los dispositivos reciban el software publicado a través de flujos de trabajo de lanzamiento autorizados de Enigm y que los dispositivos verifiquen la autenticidad, la integridad y el cumplimiento de las políticas de la versión antes de aceptar una actualización.

## Entrega segura de software

La entrega segura de software combina control de lanzamiento, firma, validación, controles de elegibilidad, control de implementación y verificación del lado del dispositivo.

La entrega segura depende de:

- Flujos de trabajo de lanzamiento autorizados.
- Verificación de metadatos de release.
...
La arquitectura OTA separa la preparación del lanzamiento, la evaluación de elegibilidad, la verificación del dispositivo y la instalación.

```mermaid
flowchart TD
  Pipeline["Canal de lanzamiento"]
...
Los lanzamientos OTA pasan por un ciclo de vida controlado antes de una amplia disponibilidad. El ciclo de vida de la versión existe para reducir el riesgo de implementación, preservar la integridad del software y mantener la responsabilidad de la versión.

Los objetivos de lanzamiento incluyen:
...
La verificación de políticas garantiza que los artefactos técnicamente válidos sigan siendo apropiados para el dispositivo solicitante y el contexto de lanzamiento.
...
La publicación del lanzamiento se rige por:
...
La firma de lanzamientos autoriza los lanzamientos. El ciclo de vida de la versión rige la implementación. La verificación del cliente valida la aceptación de la versión antes de la instalación. Estas funciones tienen diferentes propósitos.

## Relación con Trust Security Center

Trust Security Center evalúa la integridad del dispositivo local.

OTA evalúa la elegibilidad de lanzamiento y la entrega de software.
...
## Relación con la firma de autorización de release

La firma de lanzamientos autoriza los lanzamientos.
