...
La arquitectura está orientada al dispositivo local. No proporciona acceso a texto en claro de mensajes y no funciona como un sistema de inspección de contenido.
...
Inactive significa que Trust Security Center no puede determinar de forma fiable la integridad del dispositivo porque los servicios de confianza críticos no están disponibles.
...
La visibilidad de la administración de dispositivos no es visibilidad de los mensajes. Los flujos de trabajo de dispositivos administrados no deben omitir el cifrado de extremo a extremo Enigm App ni proporcionar acceso administrativo al texto en claro de los mensajes.
