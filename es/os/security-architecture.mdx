...
La visibilidad administrativa de la posición del dispositivo no equivale al acceso al texto claro del mensaje Enigm App.
...
Estos controles están destinados a reducir el riesgo y limitar el comportamiento inseguro del dispositivo. No eliminan el riesgo de comprometer los endpoints y deben evaluarse junto con el comportamiento del usuario, el estado de la cuenta y los controles a nivel de aplicación.
...
Esta capa es relevante para el material clave protegido, la postura del dispositivo y las decisiones Device Trust administradas.
...
- Revisión del ciclo de vida del lanzamiento.
- Visibilidad Trust Security Center.
...
Enigm OS no proporciona acceso a texto claro de mensajes. La confidencialidad de los mensajes Enigm App depende del cifrado a nivel de aplicación, el material de clave protegido, la asociación de dispositivos de confianza y los flujos de trabajo de verificación.
