---
title: Política de red del sistema operativo
...
- Mantenga los controles de red separados del texto claro de los mensajes.
...
Enigm OS utiliza controles destinados a reducir la cantidad, precisión o confiabilidad de los metadatos de la red observables. Estos controles afectan la exposición directa, la confianza en el tiempo, la visibilidad de la resolución de nombres y la confiabilidad de la correlación.
...
La política de red no proporciona acceso al texto claro de los mensajes y no inspecciona el contenido de los mensajes.
...
- El cifrado de extremo a extremo protege el contenido de los mensajes entre puntos finales de confianza.
