...
El manejo seguro de medios está diseñado para reducir la exposición innecesaria del texto en claro a través de visualización protegida, persistencia local limitada, caducidad y controles de resistencia a la captura de acuerdo con la capacidad y la política del dispositivo. Estos controles reducen la exposición durante el uso normal; no garantizan protección contra endpoints comprometidos, grabaciones externas o divulgación intencional por parte de participantes autorizados.
...
La creación de una cuenta Enigm estándar no requiere un correo electrónico, un número de teléfono ni un documento de identidad. Esto apoya la minimización de la identidad y reduce la exposición innecesaria de la identidad.
...
Active Defense no está diseñado para inspeccionar el texto en claro de los mensajes, el contenido de las llamadas, los medios, los archivos adjuntos, los documentos o las conversaciones de los usuarios.
...
VPN Service y Proxy Network están separados de Enigm Server y del cifrado de extremo a extremo Enigm App. No definen el modelo de seguridad de la aplicación, no reemplazan Device Trust ni brindan acceso al texto en claro de los mensajes.

El uso del servicio de red debe estar autorizado, tener en cuenta las políticas y ser auditable cuando sea relevante para la seguridad. El contenido de la comunicación Protected debe permanecer separado de los registros de políticas de red de habitual.
...
- La postura opcional de Enigm OS puede fortalecer las decisiones Device Trust cuando se implementen.
...
- Enigm Server debe admitir la membresía del servidor y los controles del ciclo de vida del contenido cifrado en el ámbito del servidor sin convertirse en una superficie de texto en claro, archivo adjunto, comunicación de usuario o acceso a clave privada.
