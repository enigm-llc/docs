...
- Visibilidad administrativa sin acceso de texto en claro a los mensajes.
...
El reemplazo asistido por recuperación no debe otorgar automáticamente acceso de texto en claro a los mensajes históricos.
...
- Las funciones administrativas no deben proporcionar acceso en texto en claro a los mensajes.
...
Enigm Command no debe proporcionar acceso en texto en claro a mensajes, material de clave privada, contenido de llamadas seguras o archivos adjuntos protegidos.
