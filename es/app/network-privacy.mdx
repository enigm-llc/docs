...
La protección VPN y el cifrado de extremo a extremo resuelven diferentes problemas. La VPN no reemplaza el cifrado de mensajes, Device Trust, las decisiones de confianza del usuario ni la seguridad de los terminales.
...
Los controles de privacidad de la red no protegen contra dispositivos terminales comprometidos, malware con privilegios suficientes, ingeniería social, divulgación de usuarios, divulgación de mensajes por parte de participantes autorizados o contenido capturado después del descifrado local autorizado.
