...
- Un mecanismo para que los administradores lean el texto en claro de mensajes privados.
- Un mecanismo para que los administradores reciban texto en claro de archivos adjuntos.
...
La administración del servidor debe permanecer separada del material de clave privada y del texto en claro de los mensajes.
...
Enigm Server no reemplaza el cifrado de extremo a extremo Enigm App. La membresía del servidor y la política del servidor afectan el acceso al entorno y la disponibilidad del contenido cifrado; no crean acceso a texto en claro, acceso a texto en claro a archivos adjuntos, acceso a comunicación de usuario ni acceso a clave criptográfica para administradores de servidores.
...
La selección de regiones está diseñada para respaldar:
...
Estos controles están diseñados para gestionar la disponibilidad de contenido cifrado dentro del entorno del servidor dedicado. Pueden incluir:
...
Los controles administrativos no otorgan acceso al texto en claro del mensaje, al texto en claro del archivo adjunto, a las comunicaciones del usuario ni al material de clave privada.
...
La eliminación total del servidor afecta el ciclo de vida y la disponibilidad del entorno del servidor dedicado. No proporciona acceso al texto en claro de los mensajes, al texto en claro de los archivos adjuntos, a las comunicaciones del usuario, a las claves criptográficas ni al material de claves protegidas.

## Límites administrativos

La administración de Enigm Server y la confidencialidad del contenido son dominios de confianza separados.

La autoridad administrativa permite el control del ciclo de vida. No proporciona visibilidad de mensajes, autoridad criptográfica, acceso a texto en claro de archivos adjuntos, acceso a comunicación de usuario ni acceso a texto en claro de mensajes.
...
- La administración del servidor es independiente del texto en claro del mensaje Enigm App.
...
- La propiedad del servidor es independiente del acceso en texto en claro al contenido del usuario.
...
flowchart TD
  ...
  Keys["Protected Material de clave"]
  Plaintext["Mensaje de texto en claro"]
...
Enigm Server está diseñado para reducir la exposición y proporcionar control a nivel del cliente sin aumentar la recopilación habitualria de contenido protegido.
