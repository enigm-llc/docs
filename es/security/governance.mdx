...
Enigm mantiene un modelo formal de gobierno de seguridad de la información diseñado para respaldar la seguridad, la privacidad, la resiliencia operativa, el cumplimiento, la garantía y la mejora continua.
...
> Sistema que da soporte a las actividades de desarrollo de aplicaciones de mensajería cifrada, según Statement of Applicability de fecha 09/09/2024.
...
| Desarrollo seguro | Demuestra que el desarrollo de software incluye controles de revisión, validación y publicación. |
...
Enigm realiza evaluaciones de seguridad recurrentes diseñadas para identificar vulnerabilidades, configuraciones erróneas y riesgos de exposición en los entornos compatibles.
...
## Transparencia de publicaciones

La plataforma puede publicar información de publicación relevante para la seguridad.
...
| Target Production Versión-Signing Authority | Arquitectura de endurecimiento de objetivos | Documentado por separado de la autoridad de firma del manifiesto OTA de producción actual. |
