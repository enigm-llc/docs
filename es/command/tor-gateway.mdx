...
El objetivo es reducir dependencia de rutas clearnet para superficies públicas compatibles y aplicar el principio de mínima exposición.

## Categorías de servicio soportadas
