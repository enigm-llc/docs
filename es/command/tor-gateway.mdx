...
El Tor Gateway está destinado a:
...
El Tor Gateway no está destinado a reemplazar la conectividad Enigm App, VPN Service, Proxy Network, Enigm eSIM, la autorización Enigm Command, Enigm Server, mensajería segura, llamadas seguras o Enigm OS.
...
El Tor Gateway no está destinado a:
...
El Tor Gateway no garantiza la protección de la identidad en todos los entornos. El comportamiento del usuario, la configuración del navegador, la seguridad de los terminales y las señales externas siguen siendo relevantes.
...
Las áreas relevantes del modelo de amenazas incluyen la exposición de la superficie pública, la configuración incorrecta de los límites de acceso público, la exposición no intencionada de flujos de trabajo confidenciales, el compromiso de los terminales, la divulgación de los usuarios y la pérdida de visibilidad de la auditoría.
