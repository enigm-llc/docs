...
Enigm Command es el panel web de control del ecosistema Enigm. Gestióna cuentas, sesiones, dispositivos, productos, pagos, Enigm Server, Enigm eSIM, Enigm Key, Tor Gateway, Enyra Product Assistant y operaciones de dispositivo gestionado.
...
- Enyra Product Assistant para guía de producto.
...
Enigm Command expone Enyra Product Assistant para guía de producto, asistencia de usuario, documentación, configuración, navegación de plataforma, ayuda de dispositivo y ayuda de cuenta.

Este modo es distinto de Enyra en Intelligence, que actúa como capa de seguridad, correlación y análisis de eventos.

## Ciclo de vida de servidores y productos

Enigm Command permite comprar y crear Enigm Server, revisar solicitudes de unión por ID de servidor, gestionar membresía, elegir región disponible, administrar Enigm eSIM, gestionar Enigm Key y revisar productos asociados.
