...
Enigm Key es un dispositivo de emergencia compacto con conectividad de datos móviles integrada. Está diseñado para escenarios en los que un usuario puede necesitar notificar a contactos de confianza seleccionados de forma rápida y discreta.
...
- Exposición mínima de datos de habitual.
...
- Seguimiento de ubicación de habitual.
- Acceso al texto en claro del mensaje.
...
- Separado del comportamiento de espera de habitual.

Cuando Enigm Key no está activado, debe permanecer inactivo y evitar informes de ubicación de habitual. Esto apoya la privacidad y la minimización de datos.
...
- No se permite compartir la ubicación de emergencia de forma habitual mientras está inactivo.
...
La visibilidad de Enigm Command debe permanecer separada del texto en claro de los mensajes, el contenido de las llamadas seguras, el contenido multimedia, los archivos adjuntos, las conversaciones de los usuarios y el seguimiento de ubicación de habitual.

## Revocación del dispositivo

La revocación de Enigm Key está disponible desde Enigm App y Enigm Command.

La revocación está diseñada para dispositivos perdidos, robados, retirados o reemplazados. Una vez revocado, ya no se debe confiar en el dispositivo para futuros flujos de trabajo de emergencia o comunicación de plataforma.
