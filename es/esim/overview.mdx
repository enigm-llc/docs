...
El servicio Enigm eSIM está diseñado para reducir la dependencia de los flujos de trabajo de identidad móviles tradicionales dentro del flujo de gestión del ciclo de vida y compras por parte de Enigm, al tiempo que proporciona conectividad de datos móviles.

El flujo de trabajo de gestión del ciclo de vida y compras por parte de Enigm no recopila:
...
Enigm eSIM puede ayudar a mitigar:
...
- El flujo de trabajo por parte de Enigm no recopila verificación KYC, correo electrónico, número de teléfono ni documento de identidad.
...
El estado de activación es el estado del ciclo de vida de la conectividad. No proporciona acceso al texto en claro de mensajes, contenido de llamadas seguras, contenido multimedia, texto en claro de archivos adjuntos, conversaciones de usuarios, material de clave protegida o material de clave privada.

Los requisitos de operadores externos, roaming o específicos de jurisdicción pueden variar fuera del flujo de trabajo de gestión del ciclo de vida y compras por parte de Enigm. Los usuarios y las organizaciones siguen siendo responsables de evaluar los requisitos locales de telecomunicaciones y registro de identidad.
...
- Asignación de direcciones IP por parte de la red de operador.
- Transporte de paquetes en la capa de operador.
- Registros de la red de operador.
...
Los registros de la capa de operador incluyen:

- Registros de tráfico de la red móvil.
- Registros de asignación de IP del operador.
...
Debido a que Enigm no opera la red de operador y no recibe esos registros de la capa del operador, Enigm no puede proporcionar registros de tráfico de la red de operador, registros de asignación de IP del operador, registros de conexión del operador o registros de telecomunicaciones del operador en respuesta a solicitudes de revisión legal, regulatoria, de soporte o empresarial.
...
La asociación de cuenta no convierte Enigm eSIM en un producto de verificación de identidad. La identidad de la cuenta de Enigm, Device Trust, el material de clave protegido y la confidencialidad de los mensajes siguen siendo dominios de confianza separados.
...
El flujo de trabajo de eSIM por parte de Enigm minimiza la identidad porque no recopila verificación KYC, correo electrónico, número de teléfono ni documento de identidad.
