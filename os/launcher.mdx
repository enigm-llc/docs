...
Security status presentation should be concise and should direct users to Trust Security Center for detailed findings where supported.
...
- It does not guarantee that all external systems are trustworthy.
